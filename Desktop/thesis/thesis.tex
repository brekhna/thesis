...
\begin{figure}
  \includegraphics[width=0.7\linewidth]{Bla_cann_Swap_BS_1_T_1000.png}
  \centering
...
\begin{figure}
  \includegraphics[width=0.7\linewidth]{Bla_cann_Swap_BS_4_T_500.png}
  \centering
  \caption{Bar Chart comparing the execution times for all the three trace files}
...
\begin{figure}
  \includegraphics[width=0.7\linewidth]{Blacksc_var_bs_t.png}
  \centering
  \caption{Graph showing how the execution time varies with varying block size for Blackscholes}
